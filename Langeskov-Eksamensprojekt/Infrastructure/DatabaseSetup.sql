...
('Brge Bllersen', 'boerge@eksempel.dk', 'Hovedgade 12', '5300', '12345678', 'I', '1985-05-20', 4, 1),
    
-- 2. Barn (Tilskudsberettiget - Indenbys)
('Lrke Lber', 'laerke@eksempel.dk', 'Skolevej 5', '5300', '98765432', 'I', '2015-10-01', 1, 3),

-- 3. ldre (Betalende, Hjeste aldersgruppe)
('Viggo Vandrehnd', 'viggo@eksempel.dk', 'Marken 8', '5300', '11223344', 'U', '1955-03-15', 5, 1),
...
('Anna Arrangr', 'anna@eksempel.dk', 'Klubhuset 1', '5300', '99887766', 'I', '1970-01-01', 4, 2),
    
-- 6. Familie Medlem #2 (Partner/Forlder)
('Jesper Lber', 'jesper@eksempel.dk', 'Skolevej 5', '5300', '98765432', 'I', '1988-02-14', 4, 3),
...
('Martin Mlstning', 'martin@mail.dk', 'Industrivej 10', '5300', '40506070', 'I', '1990-04-10', 4, 1),      -- Voksen (25-59). Indenbys. IKKE tilskudsberettiget.
...
-- 10. Senior (Betalende)
('Grethe Grn', 'grethe@gammel.dk', 'blehaven 7', '5550', '21324354', 'I', '1948-09-03', 5, 1),            -- Senior (60+). Indenbys. IKKE tilskudsberettiget.
...
('Hanne Hj', 'hanne@family.dk', 'Bygaden 1', '5550', '65748392', 'U', '1975-12-01', 4, 3),                 -- Voksen (25-59). Udenbys. IKKE tilskudsberettiget.
...
('Freja Fynbo', 'freja@fyn.dk', 'stgade 1', '5300', '50403020', 'I', '1980-06-06', 4, 3),                 -- Voksen (25-59). Indenbys. IKKE tilskudsberettiget.

-- 18. Voksen (Family, Indenbys)
('Jens Jylland', 'jens@fyn.dk', 'stgade 1', '5300', '50403020', 'I', '1978-07-07', 4, 3),                 -- Voksen (25-59). Indenbys. IKKE tilskudsberettiget.

-- 19. Ungdom (Indenbys, Single)
('Katrine Kvik', 'katrine@kvik.dk', 'Svejen 9', '5380', '14725836', 'I', '2007-03-20', 2, 1),               -- Ungdom (13-18). Indenbys. TILSKUDSBERETTIGET (<25, I).
