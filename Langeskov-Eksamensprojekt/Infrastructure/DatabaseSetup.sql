...
('Boerge Boellersen', 'boerge@eksempel.dk', 'Hovedgade 12', '5300', '12345678', 'Mand', '1985-05-20', 4, 1),
    
-- 2. Barn (Tilskudsberettiget - Indenbys)
('Laerke Loeber', 'laerke@eksempel.dk', 'Skolevej 5', '5300', '98765432', 'Kvinde', '2015-10-01', 1, 3),
...
('Anna Arrangoer', 'anna@eksempel.dk', 'Klubhuset 1', '5300', '99887766', 'Kvinde', '1970-01-01', 4, 2),
    
-- 6. Familie Medlem #2 (Partner/Forlder)
('Jesper Loeber', 'jesper@eksempel.dk', 'Skolevej 5', '5300', '98765432', 'Mand', '1988-02-14', 4, 3),
...
('Martin Maalsaetning', 'martin@mail.dk', 'Industrivej 10', '5300', '40506070', 'Mand', '1990-04-10', 4, 1),      -- Voksen (25-59). Indenbys. IKKE tilskudsberettiget.
...
-- 10. Senior (Betalende)
('Grethe Groen', 'grethe@gammel.dk', 'Aeblehaven 7', '5550', '21324354', 'Kvinde', '1948-09-03', 5, 1),            -- Senior (60+). Indenbys. IKKE tilskudsberettiget.
...
('Hanne Hoej', 'hanne@family.dk', 'Bygaden 1', '5550', '65748392', 'Kvinde', '1975-12-01', 4, 3),                 -- Voksen (25-59). Udenbys. IKKE tilskudsberettiget.
...
('Freja Fynbo', 'freja@fyn.dk', 'Oestgade 1', '5300', '50403020', 'Kvinde', '1980-06-06', 4, 3),                 -- Voksen (25-59). Indenbys. IKKE tilskudsberettiget.

-- 18. Voksen (Family, Indenbys)
('Jens Jylland', 'jens@fyn.dk', 'Oestgade 1', '5300', '50403020', 'Mand', '1978-07-07', 4, 3),                 -- Voksen (25-59). Indenbys. IKKE tilskudsberettiget.
